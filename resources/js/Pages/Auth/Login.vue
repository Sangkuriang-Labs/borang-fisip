        ...
        <div>
          ...
          >
            ...
            <path
              ...
              transform="translate(-165.00003 -189.93073)"
            />
            <circle cx="524.99994" cy="335.5" fill="#6c63ff" r="16" />
            <polygon
              fill="#ffb8b8"
            ...
            <path
              ...
              transform="translate(-165.00003 -189.93073)"
            />
            <circle cx="612.1058" cy="162.12254" fill="#ffb8b8" r="24.56103" />
            <path
            ...
            <rect
              ...
              y="201.38965"
            />
            <rect fill="#ccc" height="2" width="143" x="332.99994" y="315.5" />
            <rect fill="#ccc" height="304" width="2" x="377.49994" y="107.5" />
            <rect fill="#ccc" height="304" width="2" x="427.49994" y="107.5" />
          </svg>
          <h2 class="mt-6 text-3xl font-extrabold text-gray-900">
            Masuk kedalam akun anda
          </h2>
          <p class="mt-2 text-sm text-gray-600">
            Atau jika belum memiliki akun silahkan registrasi
            {{ " " }}
            <Link
              as="a"
