  ...
  <div class="flex min-h-full">
    ...
    >
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          <Link
            class="font-sm inline-flex items-center text-indigo-600 hover:font-semibold hover:text-indigo-500 hover:underline"
            href="/login"
          >
            <svg
              class="h-4 w-4"
          ...
          >
            ...
            <path
              ...
              transform="translate(-124.38226 -133.06928)"
            />
            <circle cx="540.23547" cy="106.16225" fill="#6c63ff" r="15" />
            <circle cx="643.23547" cy="106.16225" fill="#6c63ff" r="15" />
            <circle cx="746.23547" cy="106.16225" fill="#6c63ff" r="15" />
            <circle cx="849.23547" cy="106.16225" fill="#6c63ff" r="15" />
          </svg>
