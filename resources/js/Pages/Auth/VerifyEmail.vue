        ...
        <Link class="inline-flex" href="/">
          ...
          >
            ...
            <path
              ...
              transform="translate(-219.72324 -203.06487)"
            />
            <circle cx="121.72635" cy="153.52379" fill="#ffb8b8" r="24.56103" />
            <path
      ...
      <div class="py-16">
        <div class="text-center">
          ...
          <p class="mt-2 text-base text-gray-500">
            Silahkan cek inbox atau spam dalam email anda. Belum menerima email
            verifikasi? silahkan klik
            <Link
          ...
          <div class="mt-6">
            <Link
              as="a"
              class="inline-flex items-center text-base font-medium text-indigo-600 hover:text-indigo-500 hover:underline"
              href="/logout"
              method="post"
            >
              <svg
