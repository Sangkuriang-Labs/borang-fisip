<template>
  ...
  >
    <div class="px-4 py-5 sm:px-6">
      ...
      <div class="bg-white">
        <div
          class="mx-auto flex max-w-7xl flex-col flex-col-reverse items-center justify-evenly gap-y-10 py-8 px-2 sm:py-12 sm:px-3 lg:flex-row lg:gap-y-0 lg:px-8"
        >
          <div class="max-w-xl">
            <h2
          ...
          <div class="mt-10 w-full max-w-xs">
            ...
            >
              ...
              <path
                ...
                transform="translate(-211.49963 -246.00077)"
              />
              <circle cx="159.87891" cy="54.55562" fill="#2f2e41" r="30" />
              <circle cx="159.6978" cy="62.34302" fill="#ffb8b8" r="24.56103" />
              <path
            ...
            <div class="px-4 py-4 sm:px-6">
              <div class="flex items-center justify-between">
                ...
                <div class="ml-2 flex flex-shrink-0">
                  <p
                    class="inline-flex rounded-full bg-green-100 px-2 text-sm font-semibold leading-5 text-green-800"
                  >
                    {{ sub.number }}
                  </p>
                </div>
